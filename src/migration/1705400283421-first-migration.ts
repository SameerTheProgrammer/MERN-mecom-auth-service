...
export class FirstMigration1705400283421 implements MigrationInterface {
    name = "FirstMigration1705400283421";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "sellerRefreshTokens" ("id" SERIAL NOT NULL, "expireAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_ee061ef57985c2f2421281a2d42" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
